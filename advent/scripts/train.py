...
from advent.dataset.smoke import SmokeDataSet   ###### Custom Dataset
...
def main():
    ...
    # DATALOADERS
    source_dataset = SmokeDataSet(root=cfg.DATA_DIRECTORY_SOURCE,     ###### Custom Dataset
    ...
    target_dataset = SmokeDataSet(root=cfg.DATA_DIRECTORY_TARGET,      ###### Custom Dataset
